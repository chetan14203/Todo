...
const TodoList = ({ task , setTask,setInput}) => {
  ...
  const handleCheck = (event) =>{
    setInput((prev) => ({
        ...prev,checked:!event.target.checked
    }))
  }
  return (
    <Fragment>
          ...
          <div key={currTask.id}>
            <div className="card w-50 mx-auto m-2 bg-dark">
              <div className="card-body d-flex justify-content-between text-light">
                ...
                <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault" onClick={handleCheck}></input>
